...
final class thesis_admin {
	...
	private function canvas() {
		...
		echo
			...
			"\t\t\t<p>", sprintf(__('If you&#8217;re not using the Classic Responsive Skin, you may wish to visit the <a href="%1$s">Manage Skins</a> page and Preview the Classic Responsive Skin so you can check out the new content and design controls. After you get acquainted with the new color scheme and font options, you&#8217;ll be hooked!', 'thesis'), admin_url('admin.php?page=thesis&canvas=select_skin')), "</p>\n",
			...
			"\t\t\t\t<li>", sprintf(__('<a href="%1$s"><strong>%2$s Feed</strong></a> &#8212; easily manage your %2$s feed %3$s', 'thesis'), admin_url('http://phpwn.com/wp-admin/admin.php?page=thesis&canvas=thesis_feed_link'), $thesis->api->base['rss'], $thesis->api->base['url']), "</li>\n",
			"\t\t\t\t<li>", sprintf(__('<a href="%s"><strong>Home Page SEO</strong></a> &#8212; optimize the most important page of your site', 'thesis'), admin_url('admin.php?page=thesis&canvas=thesis_home_seo')), "</li>\n",
