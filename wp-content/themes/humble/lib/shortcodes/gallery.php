...
function theme_shortcode_gallery( $output, $attr ) {
	...
	foreach ( $attachments as $id => $attachment ) {
		...
		if(isset( $attr['link'] ) && 'file' == $attr['link']){
			$image = '<a href="' . $img_lnk . '" class="fancy img_icon_zoom gallery-image-wrap" title="' . $lightbox_title . '" rel="' . $img_rel . '">'.$image.'</a>';
		}else{
			$image = '<a href="' . get_attachment_link($id) . '" class="gallery-image-wrap" title="' . $lightbox_title . '" rel="' . $img_rel . '">'.$image.'</a>';
		}
