<?php
/*
 * Plugin Name: Custom Frontpage widget
...
class rf_fronttext_widget extends WP_Widget {
	...
	function rf_fronttext_widget() {
		...
		$this->WP_Widget( 'rf_fronttext_widget', 'Custom Frontpage Widget', $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		<div class="rf_fronttext_widget">
			<?php if ($image) { ?>
            <a class="fancybox image-container hoverfade" href="<?php echo $url; ?>" title="<?php echo $title; ?>" rel="fancybox">
            ...
            <?php if ($url) { ?>
                <a class="button yellow dark-text" href="<?php echo $url; ?>" class="title">Read more</a>
            <?php } ?>
		</div>
